...
<body>
    <div class="containersuppr">
        <form id="DeleteMedecin" action="ConfirmationSuppression.php" method="POST">
            <h2>Voulez-vous vraiment supprimer le médecin: <?php echo $medecin->nom_medecin . ' ' . $medecin->prenom_medecin; ?> ?</h2><br/>
